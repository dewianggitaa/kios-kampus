    ...
    <div className="bg-gray-100">
      ...
      <div className='bg-gray-100 h-screen overflow-y-scroll'>
        <div className="px-16 py-8">
          <div>
            <div className='font-semibold text-sm md:text-md mb-2'>Your Profile</div>
            <div className="bg-white flex w-full gap-4 p-4 justify-evenly border shadow-lg rounded-xl">
              <div className="flex flex-col items-center">
                <PiUserCircle className="text-6xl md:text-9xl text-gray-800 mb-5" />
                <button
              ...
              <div className='flex flex-col justify-center items-start gap-4'>
                <div>
                  ...
                  <div className='text-xs md:text-lg'>{user.name}</div>
                </div>
                ...
                <div>
                  <div className='text-xs font-light italic'>WhatsApp</div>
                  <div className='text-xs md:text-lg'>{user.no_wa}</div>
                </div>

                <Link to={'/edit-profile'}>
                  <button className=" text-smflex justify-center w-full bg-green-700 hover:bg-green-900 text-[#FFFFFF] text-sm rounded-xl px-4 py-2 text-center">
                    Edit Profile
                  </button>
                </Link>
              </div>
        ...
        <div className="px-16 py-8">
          ...
          <div className="gap-6 flex flex-col flex-wrap border border-slate-100 bg-white shadow-md rounded-xl text-left">
            {products ? (
